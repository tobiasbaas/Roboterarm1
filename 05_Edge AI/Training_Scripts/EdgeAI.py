...
def export_model(quantize_override: Optional[bool] = None):
    """[4] Exportiert das beste Modell nach ONNX, optional mit INT8-Quantisierung."""
    candidates = [
        _best_weights_for_base("roboterarm_pose_real_opt"),
        _best_weights_for_base("roboterarm_pose_real"),
        _best_weights_for_base("roboterarm_pose_opt"),
        _best_weights_for_base("roboterarm_pose"),
        _best_weights_for_base("roboterarm_real_opt"),
        _best_weights_for_base("roboterarm_real"),
        _best_weights_for_base("roboterarm_seg_opt"),
        _best_weights_for_base("roboterarm_seg", PRETRAINED_SEG),
    ]
