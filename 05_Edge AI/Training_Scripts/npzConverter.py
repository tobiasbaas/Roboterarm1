...
Usage:
    python .\npzConverter.py --images ..\..\Image_Capture_Python\dataset\images\<capture_ordner> --out ..\..\Image_Capture_Python\dataset\images\<capture_ordner>\calibration.npz --imgsz 640 --count 3 --norm_to_1
