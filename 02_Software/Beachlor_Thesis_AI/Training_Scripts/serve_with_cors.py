...
class CORSRequestHandler(SimpleHTTPRequestHandler):
    def end_headers(self) -> None:
        # Set proper Content-Type for images (override default)
        if self.path.lower().endswith(('.png', '.jpg', '.jpeg', '.gif', '.webp', '.bmp')):
        ...
        print(f"  → {self.path} | Content-Type: {content_type} | Content-Length: {content_length}")
