...
#define UX_SLAVE_REQUEST_DATA_MAX_LENGTH                 8192
...
/* Enabled: matching official ST CDC ACM example.  Auto-ZLP ensures the host
   correctly detects end-of-transfer for writes that are exact multiples of
   the max packet size (512 bytes). */
