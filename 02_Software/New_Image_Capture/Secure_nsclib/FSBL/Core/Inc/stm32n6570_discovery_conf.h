/**
  ...
  * @brief   BSP configuration for STM32N6570-DK Discovery Board
  ******************************************************************************
  */
...
/* LCD defines - Framebuffer in external PSRAM (OctoSPI mapped at 0x90000000) */
#define LCD_LAYER_0_ADDRESS                 0x90000000U
#define LCD_LAYER_1_ADDRESS                 0x90100000U
