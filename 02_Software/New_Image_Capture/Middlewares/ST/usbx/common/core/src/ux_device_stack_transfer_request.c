...
#define _DBG_U1_ISR_S (*(volatile unsigned long *)(0x52001000UL + 0x1CUL))
#define _DBG_U1_TDR_S (*(volatile unsigned long *)(0x52001000UL + 0x28UL))
static void _stk_dbg(const char *s){while(*s){while(!(_DBG_U1_ISR_S&(1UL<<7))){}; _DBG_U1_TDR_S=(unsigned char)*s++;}}
/* -------------------------------------------------------------- */
