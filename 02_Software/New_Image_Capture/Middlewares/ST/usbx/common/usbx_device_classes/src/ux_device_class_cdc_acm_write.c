...
#define _DBG_U1_ISR (*(volatile unsigned long *)(0x52001000UL + 0x1CUL))
#define _DBG_U1_TDR (*(volatile unsigned long *)(0x52001000UL + 0x28UL))
static void _wr_dbg(const char *s){while(*s){while(!(_DBG_U1_ISR&(1UL<<7))){}; _DBG_U1_TDR=(unsigned char)*s++;}}
/* -------------------------------------------------------------- */
